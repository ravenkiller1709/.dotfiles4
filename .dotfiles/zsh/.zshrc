...
alias cda='cd ~/.config/awesomw'
alias a='cd ~/.config/awesome && nvim rc.lua'
alias cdt='cd ~/.config/awesome/themes/powerarrow-dark'
alias t='cd ~/.config/awesome/themes/powerarrow-dark && nvim theme.lua'
